...
.status-received { background: #f0fff4; color: var(--success); border: 1px solid #9ae6b4; }
.status-cancelled{ background: #fff5f5; color: var(--danger); border: 1px solid #fed7d7; }

/* ── Amount ───────────────────────────────── */
.amount-cell { font-weight: 700; color: var(--brand-navy); }

/* ── Notes cell ───────────────────────────── */
.notes-cell { font-size: .78rem; color: var(--text-muted); max-width: 140px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.btn-receive { background: #f0fff4; color: var(--success); }
    ...
    <div class="main-card-header">
      ...
      <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
        ...
        <form method="GET" style="display:flex; align-items:center; gap:6px;">
          <i class="bi bi-funnel" style="color:var(--text-muted); font-size:.9rem;"></i>
    ...
    <div style="overflow-x:auto;">
      <table id="poTable">
        ...
        <tr>
          ...
          <td style="font-size:.8rem; color:var(--text-muted);"><?php echo htmlspecialchars($po['createdBy']); ?></td>
          <td>
          ...
          <td style="font-size:.82rem; color:var(--text-muted);"><?php echo date('M d, Y', strtotime($po['dateCreated'])); ?></td>
          <td style="font-size:.82rem; color:var(--text-muted);"><?php echo $po['dateReceived'] ? date('M d, Y', strtotime($po['dateReceived'])) : '<span style="color:#ccc;">—</span>'; ?></td>
